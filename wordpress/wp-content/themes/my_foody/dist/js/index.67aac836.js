    ...
    const resizeIngredients = ()=>{
        ...
        btns.forEach((btn)=>{
            btn.addEventListener("click", function(e) {
                ...
                const newNumberPerson = isIncrease ? numberPersonInitial + 1 : Math.max(1, numberPersonInitial - 1);
                ...
                quantities.forEach((el)=>{
                    ...
                    if (isNaN(quantity)) {
                        console.error("Quantit\xe9 invalide pour l'\xe9l\xe9ment:", el);
                        return;
                    }
...
//# sourceMappingURL=index.67aac836.js.map

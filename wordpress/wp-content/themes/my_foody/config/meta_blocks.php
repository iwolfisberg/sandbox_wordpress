...
class MetaBlock
{
  ...
  {
    add_action('add_meta_boxes', [$this, 'add_ingredient_metabox']);
    add_action('save_post', [$this, 'save_ingredient_metabox']);

  }


  public function add_ingredient_metabox()
  {
    // Enregistrer un metabox qui apparaîtra sur les articles
    add_meta_box(
      'ingredient_metabox',            // ID unique
      'Ingrédients',                   // Titre du metabox
      [$this, 'render_ingredient_metabox'],     // Fonction pour afficher le metabox
  ...
  public function render_ingredient_metabox($post)
  {
    ...
    <div id="ingredient-metabox">
      <div class="acf-field acf-field-number first-box">
        ...
        <div class="acf-input">
          <input type="number" id="people_count" name="people_count" value="<?php echo esc_attr($people_count); ?>"
        ...
        <?php foreach ($ingredients as $index => $ingredient): ?>
          <li class="item">
            <div class="acf-field acf-field-number">
              ...
              <div class="acf-input">
                <input type="text" id="ingredient-name-<?php echo $index; ?>" name="ingredient[<?php echo $index; ?>][name]"
                  value="<?php echo esc_attr($ingredient['name']); ?>" placeholder="Nom de l'ingrédient" />
              </div>
            </div>
            <div class="acf-field acf-field-number">
              <div class="acf-label">
              ...
              <div class="acf-input">
                <input type="number" id="ingredient-quantity-<?php echo $index; ?>"
                  name="ingredient[<?php echo $index; ?>][quantity]" value="<?php echo esc_attr($ingredient['quantity']); ?>"
            ...
            <div class="acf-field acf-field-number">
              ...
              <div class="acf-input">
                <input type="text" id="ingredient-unit-<?php echo $index; ?>" name="ingredient[<?php echo $index; ?>][unit]"
                  value="<?php echo esc_attr($ingredient['unit']); ?>" placeholder="Unité" />
              </div>
            </div>
  ...
  public function save_ingredient_metabox($post_id)
  {

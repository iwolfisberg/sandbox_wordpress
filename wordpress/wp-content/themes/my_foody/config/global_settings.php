...
add_action('wp_enqueue_scripts', 'foody_load_assets');
 ...
 */
function add_info_to_context($context) {
...
// Ajoute la fonction au filtre `timber/context` pour enrichir le contexte passé à Twig.
add_filter('timber/context', 'add_info_to_context');
...
// Ajoute la fonction à l'action `init` pour enregistrer les variables au bon moment.
add_action('init', 'add_custom_query_var');

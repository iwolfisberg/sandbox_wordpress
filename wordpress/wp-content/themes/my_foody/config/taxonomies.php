 ...
 */
function register_menu_types_taxonomy() {
  register_taxonomy(
...
// Ajoute la fonction d'enregistrement de la taxonomie au hook 'init'
add_action('init', 'register_menu_types_taxonomy');
...
// Ajoute la fonction d'enregistrement de la taxonomie au hook 'init'
add_action('init', 'register_diet_taxonomy');
